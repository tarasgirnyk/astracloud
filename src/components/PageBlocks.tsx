...
import { FaqIndex, type FaqIndexBlockProps } from '@/blocks/faq-index/Component'
    ...
    <>
      {blocks.map((block, index) => {
        switch (block.blockType) {
          case 'hero':
            return <Hero key={index} {...block} ctaHref={resolveHostbillHref(block.ctaHref)} />
          case 'partners':
          ...
          case 'faq-index':
            return <FaqIndex key={index} {...block} />
          case 'consultation':
