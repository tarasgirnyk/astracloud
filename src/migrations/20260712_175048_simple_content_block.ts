...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_simple_content" (
  	"_order" integer NOT NULL,
  ...
  ALTER TABLE "pages_blocks_simple_content" ADD CONSTRAINT "pages_blocks_simple_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_simple_content_order_idx" ON "pages_blocks_simple_content" USING btree ("_order");
  CREATE INDEX "pages_blocks_simple_content_parent_id_idx" ON "pages_blocks_simple_content" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_simple_content_path_idx" ON "pages_blocks_simple_content" USING btree ("_path");`)
}
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_simple_content" CASCADE;`)
}
